    ...
    <nav class="bg-white">
        ...
        >
            <a href="/" class="flex items-center">
                <img src="img/logo_noBg.png" class="h-8 mr-3" alt=" Logo" />
                <span
    ...
    <section class="bg-white dark:bg-gray-900">
        ...
        >
            <div class="flex flex-col justify-center">
                ...
                >
                    <a
                        href="https://github.com/fadhiladikaputra"
                    ...
                    <a
                        href="https://www.instagram.com/f4dhil5/"
                ...
                <div class="p-2 bg-red-600 rounded-lg shadow-lg sm:p-3">
                    <div class="flex flex-wrap items-center justify-between">
                        ...
                        >
                            ...
                            <p
                                class="ml-3 font-medium tracking-wide text-white truncate"
                            >
                                Give me coffee
                            </p>
                        </a>
        ...
        <div className="mx-auto max-w-screen-xl  px-4 sm:px-6">
            ...
            >
                ...
                <div className="text-sm text-gray-600 mr-4">
                    &copy; Created with love. All rights reserved.
                </div>
            </div>
        </div>
    </footer>
